...
const Hero = () => {
  return (
    ...
    >
      <div
        className={`flex-1 ${styles.flexStart} flex-col x1:px0 sm:px16 px:6`}
      >
        ...
        <div className="flex flex-row justify-between items-center w-full">
          ...
          <div className="ss:flex hidden md:mr4 mr-10">
            <GetStarted />
          </div>
        </div>
      ...
      >
        ...
        <div className="absolute z-[0] w-[50%] h-[50%] right-50 bottom-50 blue__gradient" />
      </div>
